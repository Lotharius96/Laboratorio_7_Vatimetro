...
{
    #ifdef isr_Tx_INTERRUPT_INTERRUPT_CALLBACK
        isr_Tx_Interrupt_InterruptCallback();
    #endif /* isr_Tx_INTERRUPT_INTERRUPT_CALLBACK */ 
...
*
*   Note calling isr_Tx_Start or isr_Tx_StartEx will 
*   override any effect this API would have had. This API should only be called
*   after isr_Tx_Start or isr_Tx_StartEx has been called. 
