...
module CharLCD_v2_20_2 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("c9eda559-d800-40b6-9607-9c4fb08a328a/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("220be342-3558-4f68-823c-e7ffb9f18c34"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__RST_2_net;
	wire [0:0] tmpIO_0__RST_2_net;
	wire [0:0] tmpINTERRUPT_0__RST_2_net;
	electrical [0:0] tmpSIOVREF__RST_2_net;

	cy_psoc3_pins_v1_10
		#(.id("d2c25043-2ed7-4dad-a72f-480dc422b518"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		RST_2
		 (.oe(tmpOE__RST_2_net),
		  .y({1'b0}),
		  .fb({Net_6}),
		  .io({tmpIO_0__RST_2_net[0:0]}),
		  .siovref(tmpSIOVREF__RST_2_net),
		  .interrupt({tmpINTERRUPT_0__RST_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RST_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
